{{ config(
    ...
    meta={
        'database_tags':{
            'table': {
                'PROTOCOL': 'TRADER JOE, WOOFI, GMX, KYBERSWAP, ZYBERSWAP, DODO, FRAX, CAMELOT, UNISWAP, SUSHI, CURVE, BALANCER, HASHFLOW, PANCAKESWAP, RAMSES, MAVERICK, DEXALOT',
                'PURPOSE': 'DEX, SWAPS'
            }
        }
    },
...
SELECT
  ...
  ROUND(
        CASE
            WHEN token_in <> '0x82af49447d8a07e3bd95bd0d56f35241523fbab1' or not token_in_is_verified
            AND (
    ...
    ROUND(
        CASE
            WHEN token_out <> '0x82af49447d8a07e3bd95bd0d56f35241523fbab1' or not token_out_is_verified
            AND (
