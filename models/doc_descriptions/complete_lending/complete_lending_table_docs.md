...
This table contains transactions where users borrowed assets across AAVE, COMPOUND, SILO, RADIANT, and LODESTAR protocols. In order to borrow assets, a user must first deposit their preferred asset and amount as collateral.
