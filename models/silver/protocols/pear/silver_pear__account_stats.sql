...
SELECT
    f.trader,
    f.first_trade_timestamp,
    f.last_trade_timestamp,
    f.account_age,
    f.trade_count,
    f.trade_count_mtd,
    f.gmx_trade_count,
    f.symmio_trade_count,
    f.vertex_trade_count,
    f.perp_trade_count,
    f.long_count,
    f.short_count,
    f.total_usd_volume,
    f.total_usd_volume_24h,
    f.total_usd_volume_mtd,
    f.avg_usd_trade_size,
    f.total_fee_amount,
    f.total_liquidation_amount,
    f.total_liquidation_count,
    f.current_rebate_rate,
    f.current_rebate_tier,
    f.estimated_rebate_amount,
    f.most_recent_staked_amount,
    f.current_fee_discount_rate,
