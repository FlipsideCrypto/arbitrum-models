...
WITH liquidation AS(
    ...
    FROM
        {{ ref('silver__logs') }}
    WHERE
        topics [0] :: STRING IN = '0xe413a321e8681d831f4dbccbca790d2952b56f977908e45be37335533e005286'
...
FROM
    ...
    AND liquidation.aave_version = amd.atoken_version qualify(ROW_NUMBER() over(PARTITION BY _log_id
ORDER BY
