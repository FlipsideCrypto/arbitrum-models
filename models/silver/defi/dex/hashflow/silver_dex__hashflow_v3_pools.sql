...
WITH logs_pull AS (
    ...
    WHERE
        ...
        OR tx_hash = '0xed0c8759a387acbba80a0ba985c151f3086fe407e0ffb1a83bdebb7ef44a724c'
...
FROM
    logs_pull
WHERE
    tx_hash = '0xed0c8759a387acbba80a0ba985c151f3086fe407e0ffb1a83bdebb7ef44a724c'
UNION ALL
SELECT
    tx_hash,
    block_number,
