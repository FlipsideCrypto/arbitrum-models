...
FINAL AS (
    SELECT
        ...
        e.base_delta_amount_unadj AS edge_base_delta_unadj,
        p.base_delta_amount_unadj AS user_base_delta_unadj,
        e.base_delta_amount AS edge_base_delta,
        p.base_delta_amount AS user_base_delta,
        e.quote_delta_amount_unadj AS edge_quote_delta_unadj,
        p.quote_delta_amount_unadj AS user_quote_delta_unadj,
